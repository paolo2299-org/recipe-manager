            ...
            [
                {
                    ...
                    "content": (
                        ...
                        "- If `unit` is provided, use that unit; the reference_quantity must "
                        "  be expressed in that unit (e.g. unit='g' -> reference_quantity=100 "
                        "  meaning 100 g).\n"
                        "- If `unit` is null, pick the most natural unit for that ingredient "
                        "  (whole items, cups, tbsp, etc.) and set it on the returned entry.\n"
